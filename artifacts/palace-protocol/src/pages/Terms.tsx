  ...
  return (
    <div className="bg-bone min-h-screen">
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 32px" }}>
        ...
        <h1 className="font-serif text-4xl text-ink mb-10">Terms of Service</h1>
        <div className="space-y-5">
          ...
          {!text && <p className="text-ink opacity-50 italic">No terms of service have been published yet.</p>}
        </div>
      </div>
    </div>
  );
